...
- Production uses the Tokyo Amazon Nova Lite foundation model plus a configured
  Titan embedding model and receives only the exact streaming and embedding
  model permissions. Local
