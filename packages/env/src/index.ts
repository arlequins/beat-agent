...
export const LambdaEnvironment = {
  ...
  ...(serverEnv.AGENT_JOBS_QUEUE_URL
    ? { AGENT_JOBS_QUEUE_URL: serverEnv.AGENT_JOBS_QUEUE_URL }
    : {}),
  AGENT_MAX_COMPLETION_TOKENS: String(
    serverEnv.AGENT_MAX_COMPLETION_TOKENS ?? 2_048,
  ),
  AGENT_MAX_DOCUMENTS: String(serverEnv.AGENT_MAX_DOCUMENTS ?? 250),
  AGENT_MAX_MEMORIES: String(serverEnv.AGENT_MAX_MEMORIES ?? 5_000),
  AGENT_MAX_MESSAGES: String(serverEnv.AGENT_MAX_MESSAGES ?? 50_000),
  AGENT_MAX_MONTHLY_MODEL_TOKENS: String(
    serverEnv.AGENT_MAX_MONTHLY_MODEL_TOKENS ?? 1_000_000,
  ),
  AGENT_MAX_STORAGE_BYTES: String(
    serverEnv.AGENT_MAX_STORAGE_BYTES ?? 104_857_600,
  ),
